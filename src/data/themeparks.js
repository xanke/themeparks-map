export const THEMEPARKS = [
  ...
  },
  {
    ...
    value: 'california',
    tags: ['disneypand'],
    layerUrl: 'https://secure.parksandresorts.wdpromedia.com/media/maps/prod/disneyland/96/{z}/{x}/{y}.jpg',
  ...
  },
  {
    ...
    value: 'orlando',
    tags: ['disneypand'],
    layerUrl: 'https://cdn6.parksmedia.wdprapps.disney.com/media/maps/prod/wdw/165/{z}/{x}/{y}.jpg',
    center: [28.418862, -81.581254]
  },
  {
    label: 'Token Disney Resort',
    value: 'tokyo',
    tags: ['disneypand'],
    layerUrl: 'https://contents-portal.tokyodisneyresort.jp/limited/map-image/20210210110000/nighttime/z{z}/{x}_{y}.jpg',
    center: [35.37, 139.52]
  },
