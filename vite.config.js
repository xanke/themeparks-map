  ...
  server: {
    proxy: {
      ...
      '/tkydl': {
        ...
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/tkydl/, ''),
        configure: (proxy) => {
          proxy.on('proxyReq', (proxyReq) => {
            proxyReq.setHeader(
              'Cookie',
              'CloudFront-Signature=Pw4XeQZ~DNTK65bYShZh~GN10DFexR2C2C0O-2wnuh5Zq~lFLml1kMbDEe~fVhydaz-CgwapSZcD6kHRjLDkVQqvaIW~hZd2mGbc~IyVDpfzbSPj~k~BHXU4oJVNebpkO~n8u-ZVlyRhDkNUGweaYOsUhAPFXfzeTbqOv02lOLTI220zj85xY0YFZYU4lLyGgh1KaLtCJHo6xPX3ST7REEqR71~3u9WErHhXcJbRsc3z1di0am3Pt4wPAb-lqFEa53ddbgt0zkYMF-VYcckN8MhFEJat13MhTbo9nZHTM1yOBOjHE0~UkcxoIB2OyPdHkELT1tZjmyRtPfnXvvylkQ__;CloudFront-Key-Pair-Id=APKAIJUGP2GGEWDAPMTQ;CloudFront-Policy=eyJTdGF0ZW1lbnQiOiBbeyJSZXNvdXJjZSI6Imh0dHBzOi8vY29udGVudHMtcG9ydGFsLnRva3lvZGlzbmV5cmVzb3J0LmpwLyoiLCJDb25kaXRpb24iOnsiRGF0ZUxlc3NUaGFuIjp7IkFXUzpFcG9jaFRpbWUiOjE3NzA2Mjc5Nzh9LCJJcEFkZHJlc3MiOnsiQVdTOlNvdXJjZUlwIjoiMC4wLjAuMC8wIn19fV19'
            )
          })
        }
      },
